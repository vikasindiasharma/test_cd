"""
Django settings for colabelsite project.
...
SECRET_KEY = '(k2i!ccut2#j+sgl_5%^toecr7(--0pmltw1l35t20zlxb@m)9'
...
WSGI_APPLICATION = 'colabelsite.wsgi.application'
